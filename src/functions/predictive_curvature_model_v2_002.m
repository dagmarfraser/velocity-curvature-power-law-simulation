function out = predictive_curvature_model_v2_002(x, y, fs, params)
% PREDICTIVE_CURVATURE_MODEL_V2_002  Anticipatory speed control with adaptive temporal horizon.
%
...
%       the recovered exponent.
    ...
    arguments
        ...
        params.adaptRate         (1,1) double {mustBeBetween(params.adaptRate,0,1)} = 0.05
