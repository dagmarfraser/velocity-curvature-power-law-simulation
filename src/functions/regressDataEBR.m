...
% e.g. [VGF Beta] = [1 1/3]  
% 
% Note on beta sign convention: Beta is stored and returned as a positive value (~1/3)
% throughout this toolchain. The power law relation is implemented as v = VGF × κ^(-β) where
% the negative sign is incorporated in the equation, not in the beta value itself.
%
