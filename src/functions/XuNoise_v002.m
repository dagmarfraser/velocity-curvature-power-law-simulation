function noise = XuNoise_v002(N, alpha, amplitude, fs, phi)
...
% Alpha range: unconstrained in v002 (stress-test variant).
% The GGM fractional differencing will run at any alpha; numerical
% breakdown (NaN/Inf in output) is the empirical failure signal and is
% caught by the caller's try-catch. No validation guard here.
